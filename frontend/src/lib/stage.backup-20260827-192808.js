...
// Vertical correction for the MouthDark mesh, in model units.
// Measured: MouthDark centre y=0.2260, actual lip line y=0.2355.
// Raise or lower this if it sits off her lips.
const MOUTH_DARK_LIFT = 0.0095;
  ...
  async loadModel(url) {
    ...
    if (skinnedMeshes.length) {
      ...
      if (this.mouthDark) {
        ...
        this.mouthDark.geometry.translate(0, MOUTH_DARK_LIFT, 0);
        this.mouthDark.geometry.computeBoundingSphere();
      }
